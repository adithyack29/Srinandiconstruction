...
export const metadata = {
    title: "About Us | Sri Nandi Construction",
    description: "Learn about Sri Nandi Construction, our mission, vision, and our experienced team led by Proprietor Tharun V.",
}
                ...
                <div className="container mx-auto px-4">
                    <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="h-64 rounded-xl bg-gray-200 bg-cover bg-center shadow-lg" style={{ backgroundImage: `url('/images/project-placeholder.jpg')` }} />
                            <div className="mt-8 h-64 rounded-xl bg-gray-200 bg-cover bg-center shadow-lg" style={{ backgroundImage: `url('/images/project-placeholder.jpg')` }} />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24">
                <div className="container mx-auto px-4">
                    <div className="grid gap-8 md:grid-cols-2">
                        <div className="rounded-2xl bg-primary p-12 text-white shadow-xl">
                        ...
                        <div className="rounded-2xl bg-white border border-gray-100 p-12 shadow-xl">
                ...
                <div className="container mx-auto px-4">
                    <div className="mx-auto max-w-4xl overflow-hidden rounded-3xl bg-white shadow-xl">
                        <div className="grid md:grid-cols-5">
                            <div className="md:col-span-2 bg-gray-200 h-80 md:h-auto bg-cover bg-center" style={{ backgroundImage: `url('/images/hero-placeholder.jpg')` }}>
